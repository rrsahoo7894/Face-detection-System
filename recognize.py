...
classifier = cv2.CascadeClassifier(r"C:\Users\scomc\OneDrive\Desktop\rupesh cttc\face det\face det\haarcascade_frontalface_default.xml")

model = load_model(r"C:\Users\scomc\OneDrive\Desktop\rupesh cttc\face det\face det\final_model.h5")

URL = "http://192.0.0.4:8080/shot.jpg"

def get_pred_label(pred):
    labels = ['Rupesh', 'adarsh', 'satya', 'sipra', 'sj']
    return labels[pred]
